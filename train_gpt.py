...
# Instead, we get approximately the same model (with a small hit) by quantizing the model to int6 & zlib/zstd compressing.
...
def main() -> None:
    ...
    # the compressed int8+zlib/zstd artifact and validate the round-tripped weights.
